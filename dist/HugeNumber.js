...
class HugeNumber {
    // Constants
    static ZERO = new HugeNumber(0);
    static ONE = new HugeNumber(1);
    static E = new HugeNumber(Math.E);
    static PI = new HugeNumber(Math.PI);
    static TEN = new HugeNumber(10);
...
exports.HugeNumber = HugeNumber;
//# sourceMappingURL=HugeNumber.js.map