# hugenumberts
[![npm version](https://badge.fury.io/js/hugenumberts.svg)](https://badge.fury.io/js/hugenumberts)

A library for storing extremely large numbers (up to {10, 1000, 1, 1, 2}) in Typescript. Supports both Node and browser.
